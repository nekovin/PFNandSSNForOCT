...
def evaluate_n2(metrics, denoised_images, image=None, device = "cuda" if torch.cuda.is_available() else "cpu"):
...
def evaluate_n2_with_ssm(metrics, denoised_images, image=None, device = "cuda" if torch.cuda.is_available() else "cpu"):
