...
def preprocessing_v2(n_patients, n_images_per_patient, n_neighbours=2, threshold=0.65, post_process_size=10):

    print("Process {n_patients} patients")
    
    dataset = {}
    try:
        for i in range(1, n_patients+1):
            print(f"Processing patient {i}/{n_patients}")
